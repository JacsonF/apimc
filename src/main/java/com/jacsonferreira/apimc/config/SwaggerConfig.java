...
public class SwaggerConfig {
	...
	public Docket api() {
		return new Docket(DocumentationType.SWAGGER_2).useDefaultResponseMessages(false)
				...
				.apis(RequestHandlerSelectors.basePackage("com.jacsonferreira.apimc.resources"))
				.paths(PathSelectors.any()).build().apiInfo(apiInfo());
	}

	private ApiInfo apiInfo() {
		return new ApiInfo("API for learning Spring Boot", "", "Versão 1.0", "",
				new Contact("Jacson Ferreira", "https://jacsonf.github.io/", "jacsonferreira1994@gmail.com"),
				"Allowed for students use", "", Collections.emptyList());
	}
